using eSya.InterfaceSMS.WebAPI.Utility;
using eSya.InterfaceSMS.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_InterfaceSMS = eSya.InterfaceSMS.DL.Entities;
using eSya.InterfaceSMS.IF;
using eSya.InterfaceSMS.DL.Repository;
using Microsoft.Extensions.Localization;
using eSya.InterfaceSMS.DL.Localization;
...
DL_InterfaceSMS.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
...
builder.Services.AddScoped<ISMSConnectRepository, SMSConnectRepository>();
